...
@dso_cache = dso_local local_unnamed_addr global [588 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 566681007, ; hash 0x21c6ddaf, from name: ApiConsumer.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1046238452, ; hash 0x3e5c54f4, from name: libaot-ApiConsumer
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ApiConsumer.dll.so
		ptr null; void* handle (0x0)
	}, ; 135
	...
	%struct.DSOCacheEntry {
		i64 1753503178, ; hash 0x688455ca, from name: ApiConsumer
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ApiConsumer.dll.so
		ptr null; void* handle (0x0)
	}, ; 226
	...
	%struct.DSOCacheEntry {
		i64 2393805931, ; hash 0x8eae946b, from name: libaot-MauizAppUtn.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 2596678526, ; hash 0x9ac62b7e, from name: MauizAppUtn.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MauizAppUtn.dll.so
		ptr null; void* handle (0x0)
	}, ; 365
	...
	%struct.DSOCacheEntry {
		i64 2760270583, ; hash 0xa48662f7, from name: aot-MauizAppUtn
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MauizAppUtn.dll.so
		ptr null; void* handle (0x0)
	}, ; 392
	...
	%struct.DSOCacheEntry {
		i64 2977218287, ; hash 0xb174beef, from name: aot-ApiConsumer.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ApiConsumer.dll.so
		ptr null; void* handle (0x0)
	}, ; 421
	...
	%struct.DSOCacheEntry {
		i64 3412312681, ; hash 0xcb63c269, from name: libaot-MauizAppUtn
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MauizAppUtn.dll.so
		ptr null; void* handle (0x0)
	}, ; 477
	...
	%struct.DSOCacheEntry {
		i64 3720806307, ; hash 0xddc6ffa3, from name: libaot-ApiConsumer.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ApiConsumer.dll.so
		ptr null; void* handle (0x0)
	}, ; 513
	...
	%struct.DSOCacheEntry {
		i64 3777377696, ; hash 0xe12635a0, from name: MauizAppUtn
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MauizAppUtn.dll.so
		ptr null; void* handle (0x0)
	}, ; 517
	...
	%struct.DSOCacheEntry {
		i64 3860847826, ; hash 0xe61fdcd2, from name: aot-MauizAppUtn.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MauizAppUtn.dll.so
		ptr null; void* handle (0x0)
	}, ; 529
	...
	%struct.DSOCacheEntry {
		i64 4108355697, ; hash 0xf4e08871, from name: aot-ApiConsumer
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ApiConsumer.dll.so
		ptr null; void* handle (0x0)
	}, ; 560
