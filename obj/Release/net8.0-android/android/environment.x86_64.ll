...
@dso_cache = dso_local local_unnamed_addr global [588 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 2344135322389077843, ; hash 0x20880aa7ec725f53, from name: aot-MauizAppUtn.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MauizAppUtn.dll.so
		ptr null; void* handle (0x0)
	}, ; 68
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 2440060366438366938, ; hash 0x21dcd5f9ac117eda, from name: aot-ApiConsumer.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ApiConsumer.dll.so
		ptr null; void* handle (0x0)
	}, ; 70
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 3426436081338269644, ; hash 0x2f8d257641bfbfcc, from name: ApiConsumer
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ApiConsumer.dll.so
		ptr null; void* handle (0x0)
	}, ; 106
	...
	%struct.DSOCacheEntry {
		i64 4653664673476079913, ; hash 0x4095235d46537129, from name: MauizAppUtn.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MauizAppUtn.dll.so
		ptr null; void* handle (0x0)
	}, ; 145
	...
	%struct.DSOCacheEntry {
		i64 5279382846445852551, ; hash 0x494422ba3bb21787, from name: libaot-ApiConsumer.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ApiConsumer.dll.so
		ptr null; void* handle (0x0)
	}, ; 162
	...
	%struct.DSOCacheEntry {
		i64 8707742284516750249, ; hash 0x78d81d78e044f3a9, from name: libaot-MauizAppUtn.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MauizAppUtn.dll.so
		ptr null; void* handle (0x0)
	}, ; 269
	...
	%struct.DSOCacheEntry {
		i64 9828333991984918363, ; hash 0x886541b166286f5b, from name: libaot-ApiConsumer
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ApiConsumer.dll.so
		ptr null; void* handle (0x0)
	}, ; 305
	...
	%struct.DSOCacheEntry {
		i64 10870466078508535922, ; hash 0x96dba74de06f5072, from name: MauizAppUtn
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MauizAppUtn.dll.so
		ptr null; void* handle (0x0)
	}, ; 339
	...
	%struct.DSOCacheEntry {
		i64 11526114609443115980, ; hash 0x9ff4fc2b584c13cc, from name: aot-MauizAppUtn
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MauizAppUtn.dll.so
		ptr null; void* handle (0x0)
	}, ; 366
	...
	%struct.DSOCacheEntry {
		i64 13716677424780132600, ; hash 0xbe5b6d719aa3c0f8, from name: aot-ApiConsumer
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ApiConsumer.dll.so
		ptr null; void* handle (0x0)
	}, ; 436
	...
	%struct.DSOCacheEntry {
		i64 16337909518951043682, ; hash 0xe2bbea25418cd262, from name: libaot-MauizAppUtn
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MauizAppUtn.dll.so
		ptr null; void* handle (0x0)
	}, ; 519
	...
	%struct.DSOCacheEntry {
		i64 18298819916953603068, ; hash 0xfdf277c35edccbfc, from name: ApiConsumer.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ApiConsumer.dll.so
		ptr null; void* handle (0x0)
	}, ; 581
...
@.env.3 = private unnamed_addr constant [37 x i8] c"5c077083-82ee-4359-80d7-b3c69f09465e\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [28 x i8] c"com.companyname.mauizapputn\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [26 x i8] c"libaot-ApiConsumer.dll.so\00", align 16
@.DSOCacheEntry.8_name = private unnamed_addr constant [26 x i8] c"libaot-MauizAppUtn.dll.so\00", align 16
